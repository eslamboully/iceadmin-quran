                                                                ...
                                                                @if($cat->is_static == 0)
                                                                    ...
                                                                    @elseif($cat->type == 3)
                                                                        <div class="form-group">
                                                                            <label class="control-label col-sm-2" for="img">{{$cat->translate($lang->lang)->display_name}}:</label>
                                                                            <div class="col-sm-9">
                                                                                <textarea name="{{ $lang->lang }}[{{$cat->var}}]" class="ckeditor" style="width: 100%; height: 150px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$cat->translate($lang->lang)->value}}</textarea>
                                                                            </div>
                                                                        </div>
                                                                    @endif
                                                                @endif
                                            ...
                                            @if($cat->is_static == 1)
                                                ...
                                                @elseif($cat->type == 3)
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-2" for="img">{{$cat->display_name}}:</label>
                                                        <div class="col-sm-9">
                                                            <textarea name="{{$cat->var}}" class="ckeditor" style="width: 100%; height: 150px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$cat->static_value}}</textarea>
                                                        </div>
                                                    </div>
                                                @endif
                                            @endif
