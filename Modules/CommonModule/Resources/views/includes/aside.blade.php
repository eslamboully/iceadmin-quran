...
{{--                        <!-- Categories -->--}}
{{--                        <li>--}}
{{--                            <a href="{{ url('admin-panel/trip/category') }}"><i class="fa fa-circle-o"></i>--}}
{{--                                {{__('commonmodule::sidebar.tripCateg')}}--}}
{{--                            </a>--}}
{{--                        </li>--}}

{{--                        <!-- Trip -->--}}
{{--                        <li>--}}
{{--                            <a href="{{ url('admin-panel/trip') }}"><i class="fa fa-circle-o"></i> {{__('commonmodule::sidebar.trip')}}</a>--}}
{{--                        </li>--}}

{{--                        <!-- Destination -->--}}
{{--                        <li>--}}
{{--                            <a href="{{ url('admin-panel/destination') }}"><i class="fa fa-circle-o"></i>--}}
{{--                                {{__('commonmodule::sidebar.destination')}}--}}
{{--                            </a>--}}
{{--                        </li>--}}
...
{{--                @endif--}}
                ...
                @endif
{{--                @if(in_array('office_app',$activeApps))--}}

                    <!-- contact -->
{{--                        <li><a href="{{url('admin-panel/widgets/office')}}"><i--}}
{{--                                    class="fa fa-circle-o"></i> {{__('commonmodule::sidebar.office')}}</a></li>--}}
{{--                @endif--}}
