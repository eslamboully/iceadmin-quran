                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                                ...
                                @foreach($activeLang as $lang)
                                    <div class="tab-pane @if($loop->first) active @endif"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                        <textarea id="tour_option{{ $lang->id }}" name="{{ $lang->lang }}[tour_option]" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                        <textarea id="tour_vehicles{{ $lang->id }}" name="{{ $lang->lang }}[tour_vehicles]" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input data-validation="required" type="file" autocomplete="off" name="cover">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="hours" type="text" autocomplete="off" class="form-control" name="hours"
                                       required>
                            </div>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input id="price" type="text" autocomplete="off" class="form-control" name="duelx_price"
                                        >
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <input id="price" type="text" autocomplete="off" class="form-control" name="luxury_price"
                                        >
                                </div>
