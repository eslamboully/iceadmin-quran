...
<section class="content">
  ...
  <div class="box box-info">
    ...
    @endif
    <!-- /.box-header -->
    <form class="form-horizontal" action="{{url('admin-panel/portfolio/category')}}/{{$category->id}}" method="POST" enctype="multipart/form-data">
      {{method_field('PUT')}}
      {{ csrf_field() }}
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane @if($loop->first) active @endif" id="{{ $lang->display_lang }}">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input id="title_{{$lang->lang}}" class="form-control" value="{{ ValueOf($category,$lang,'title') }}"
