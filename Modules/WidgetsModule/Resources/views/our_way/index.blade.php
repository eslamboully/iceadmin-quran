...
@section('title')
  {{__('widgetsmodule::widgets.our_way')}}
@endsection
        ...
        <div class="col-xs-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    {{-- Add New --}}
                    <a href="{{url('admin-panel/widgets/our_ways/create')}}" type="button" class="btn btn-success pull-right"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; {{__('widgetsmodule::widgets.addnew')}}</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="TeamIndex" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                  @if ($item->photo)
                                  <img src="{{asset('images/our_ways/' . $item->photo)}}" width="100" height="70">
                                  @else
                              ...
                              <td>
                                ...
                                <a title="Edit" href="{{url('admin-panel/widgets/our_ways/' . $item->id . '/edit')}}" type="button" class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                @endrole

                                {{-- Delete --}}
                                @role('superadmin')
                                <form class="inline" action="{{ route('our_ways.destroy' , $item->id) }}" method="POST">
