        ...
        <div class="col-xs-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    {{-- Add New --}}
                    <a href="{{url('admin-panel/portfolio/category/create')}}" type="button" class="btn btn-success pull-right"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; {{__('portfoliomodule::portfolio.addnew')}}</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
...
<script>
    $(document).ready(function () {
        ...
        $('#myTable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "{{ url('admin-panel/portfolio/category/datatable') }}",
                "type": "GET"
            },
            "columns": [
                { data: 'id', name: 'id' },
