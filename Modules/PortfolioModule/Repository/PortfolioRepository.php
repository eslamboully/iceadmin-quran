...
class PortfolioRepository
{
    ...
    public function find($id)
    {
     ...
     {
         $products = Portfolio::with(['portfolio_category', 'translations'])->limit(6)->get();
    ...
    public function update($id, $projectData, $portofolio_trans)
    {
        ...
        foreach (\LanguageHelper::getLang() as $lang) {
            ...
            if ($project->hasTranslation('' . $lang->lang)) {
			} else {
				$project->translateOrNew('' . $lang->lang);
            }
            ...
            if (isset($portofolio_trans[$lang->lang]['meta_title'])) {
                ...
                $project->translate('' . $lang->lang)->slug = $portofolio_trans[$lang->lang]['slug'];
                $project->translate('' . $lang->lang)->meta_keywords = $portofolio_trans[$lang->lang]['meta_keywords'];
            }
            $project->save();
