          ...
          <table id="productIndex" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  @if ($item->photo)
                    <img src="{{asset('images/products/thumb/' . $item->photo)}}" style="width: 60px">
                  @else
                    <p>No Photo</p>
                  @endif
                </td>
                ...
                <td> {{-- Edit --}}
                  ...
                  <a title="File" href="{{ route('product.files',$item->id) }}" type="button" class="btn btn-warning"><i class="fa fa-print" aria-hidden="true"></i></a>
