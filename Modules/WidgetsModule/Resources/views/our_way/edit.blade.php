...
@section('title')
  {{__('widgetsmodule::widgets.our_ways')}}
@endsection
...
<section class="content-header">
    <h1> {{__('widgetsmodule::widgets.our_ways')}} </h1>
...
<section class="content">
  ...
  <div class="box box-info">
    <div class="box-header with-border">
      <h3 class="box-title">{{__('widgetsmodule::widgets.our_ways')}}</h3>
    </div>
    @if (count($errors) > 0)
    ...
    @endif
    <!-- /.box-header -->
    <form class="form-horizontal" action="{{ route('our_ways.update',$page->id) }}" method="POST" enctype="multipart/form-data">
      {{ method_field('put') }}
      {{ csrf_field() }}
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            ...
            @if ($page->photo)
                <br>
                <img src="{{asset('images/our_ways/' . $page->photo)}}" width="100" height="70">
            @else
                <br>
      ...
      <div class="box-footer">
        <a href="{{url('/admin-panel/widgets/our_ways')}}" type="button" class="btn btn-default">{{__('widgetsmodule::widgets.cancel')}} &nbsp; <i class="fa fa-remove" aria-hidden="true"></i> </a>
