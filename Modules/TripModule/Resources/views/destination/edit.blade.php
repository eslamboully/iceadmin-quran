                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane @if($loop->first) active @endif" id="{{ $lang->display_lang }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="title_{{$lang->lang}}" type="text" autocomplete="off" class="form-control" value="{{ ValueOf($destination, $lang, 'title') }}" name="{{$lang->lang}}[title]" @if($loop->first) required @endif>
                                    </div>
                                </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane @if($loop->first) active @endif" id="seo{{ $lang->display_lang }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="meta_title_{{ $lang->lang }}" type="text" autocomplete="off" class="form-control" placeholder="Write information about your title"
                                        name="{{$lang->lang}}[meta_title]" value="{{ ValueOf($destination, $lang, 'meta_title') }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea id="meta_desc_{{$lang->lang}}" class="form-control" autocomplete="off" placeholder="Write information about your description" name="{{$lang->lang}}[meta_desc]"
                                        cols="15" rows="2">{{ ValueOf($destination, $lang, 'meta_desc') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="countKeyWords{{$lang->lang}}" autocomplete="off" type="text" class="form-control" name="{{$lang->lang}}[meta_keywords]" value="{{ ValueOf($destination, $lang, 'meta_keywords') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="slug_{{$lang->lang}}" type="text" autocomplete="off" class="form-control" name="{{$lang->lang}}[slug]" value="{{ ValueOf($destination, $lang, 'slug') }}">
                                </div>
                            </div>
