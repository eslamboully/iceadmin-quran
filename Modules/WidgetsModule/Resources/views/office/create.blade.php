...
<section class="content">
  ...
  <div class="box box-info">
    ...
    @endif
    <!-- /.box-header -->
    <form class="form-horizontal" action="{{url('admin-panel/widgets/office')}}" method="POST" enctype="multipart/form-data">
      {{ csrf_field() }}
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane @if($loop->first) active @endif" id="{{ $lang->display_lang }}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea id="editor{{$lang->id}}" class="ckeditor" name="{{$lang->lang}}[description]" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                  </div>
                </div>
              </div>
              @endforeach
