...
class ProductRepository
{
    ...
    public function update($id, $data, $data_trans, $product_categ)
    {
        ...
        foreach (\LanguageHelper::getLang() as $lang) {
            ...
            if (isset($data_trans[$lang->lang]['overview'])) {
                $product->translate('' . $lang->lang)->overview = $data_trans[$lang->lang]['overview'];
            }
            if (isset($data_trans[$lang->lang]['tech_specs'])) {
                $product->translate('' . $lang->lang)->tech_specs = $data_trans[$lang->lang]['tech_specs'];
            }
            if (isset($data_trans[$lang->lang]['accessories'])) {
                $product->translate('' . $lang->lang)->accessories = $data_trans[$lang->lang]['accessories'];
            }
