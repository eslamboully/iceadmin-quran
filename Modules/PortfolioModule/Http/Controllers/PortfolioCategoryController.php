...
class PortfolioCategoryController extends Controller
{
    ...
    function  dataTables(){
        ...
        return DataTables::of($categories)
            ...
            ->addColumn('operation', function($row) {
                ...
                $delete_tag='<a href="'. url('admin-panel/portfolio/category/delete', $row->id) .'" class="btn btn btn-danger" onclick="return confirm(\'Are you sure, You want to delete this Data?\')"><i class="glyphicon glyphicon-trash"></i></a>';
                $edit_tag='<a href="'. url("admin-panel/portfolio/category/".$row->id."/edit") .'" type="button" class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a>';
            ...
            ->addColumn('photo', function($row) {
                if($row->cover_photo){
                    return '<img width="100" height="100" src='. asset("images/project/" . $row->cover_photo).'>';
                } else {
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin-panel/portfolio/category')->with('success', 'success');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin-panel/portfolio/category')->with('updated', 'updated');
    }
