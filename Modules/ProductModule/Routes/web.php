...
Route::group(['prefix' => 'admin-panel', 'middleware' => ['auth:admin']], function() {
    ...
    Route::prefix('/')->group(function () {
        ...
        Route::get('product/files/{id}','ProductController@files')->name('product.files');
        Route::post('product/files/{id}','ProductController@upload_files')->name('product.files.post');
        Route::post('product/delete/files','ProductController@delete_files')->name('product.files.delete');
    });
