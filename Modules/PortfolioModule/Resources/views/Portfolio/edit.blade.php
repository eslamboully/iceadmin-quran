...
<section class="content">
  ...
  <div class="box box-info">
    ...
    @endif
    <!-- /.box-header -->
    <form class="form-horizontal" action="{{url('/admin-panel/portfolio/project')}}/{{$project->id}}" method="POST" enctype="multipart/form-data">
      {{method_field('PUT')}}
      {{ csrf_field() }}
      ...
      <div class="box-body">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane @if($loop->first) active @endif" id="{{ $lang->display_lang }}">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input id="title_{{$lang->lang}}" type="text" value="{{ ValueOf($project,$lang,'title') }}"
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <select class="select2 form-control" name="category_id[]" required multiple>
                                    ...
                                    @foreach($activeLang as $lang)
                                        <div class="tab-pane @if($loop->first) active @endif"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input id="meta_title_{{ $lang->lang }}" type="text"
                                                           ...
                                                           value="{{ ValueOf($project, $lang, 'meta_title') }}">
                                            ...
                                            <textarea  id="meta_desc_{{$lang->lang}}" class="form-control" autocomplete="off"
                                                      ...
                                                      rows="2">{{ ValueOf($project, $lang, 'meta_desc') }}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input  id="countKeyWords{{$lang->lang}}" autocomplete="off"
                                                           ...
                                                           value="{{ ValueOf($project, $lang, 'meta_keywords') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input id="slug_{{$lang->lang}}" type="text" autocomplete="off" class="form-control"
                                                           name="{{ $lang->lang }}[slug]"
                                                           value="{{ ValueOf($project, $lang, 'slug') }}">
                                                </div>
                                            </div>
      ...
      <div class="box-footer">
        <a href="{{url('admin-panel/portfolio/project')}}" type="button" class="btn btn-default">{{trans('portfoliomodule::portfolio.cancel')}} &nbsp; <i class="fa fa-remove" aria-hidden="true"></i> </a>
