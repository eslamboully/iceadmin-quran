          ...
          <div class="tab-content">
            ...
            <div class="tab-pane @if($loop->first) active @endif" id="{{ $lang->display_lang }}">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input id="title_{{$lang->lang}}" type="text" value="{{ ValueOf($team, $lang, 'name') }}" autocomplete="off" class="form-control" name="{{$lang->lang}}[name]" @if($loop->first) required @endif>
                </div>
              </div>
                                    ...
                                    @foreach($activeLang as $lang)
                                        <div class="tab-pane @if($loop->first) active @endif"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input id="meta_title_{{ $lang->lang }}" type="text"
                                                           ...
                                                           value="{{ ValueOf($team, $lang, 'meta_title') }}">
                                            ...
                                            <textarea  id="meta_desc_{{$lang->lang}}" class="form-control" autocomplete="off"
                                                      ...
                                                      rows="2">{{ ValueOf($team, $lang, 'meta_desc') }}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input  id="countKeyWords{{$lang->lang}}" autocomplete="off"
                                                           ...
                                                           value="{{ ValueOf($team, $lang, 'meta_keywords') }}">
